                    ...
                    <div className="pt-4 border-t border-[var(--border-primary)] bg-[var(--brand-muted)] p-4 rounded-xl">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            {[
                                ...
                                { id: LabelFormat.ZebraZpl, name: 'Zebra (ZPL)', size: '4"x6"', icon: <div className="w-full h-20 bg-gray-50 rounded border-4 border-black flex flex-col items-center justify-center space-y-2"><div className="w-8 h-8 border-2 border-black"></div><div className="w-16 h-4 border border-black"></div></div> },
                                { id: LabelFormat.A4Single, name: 'A4 Hoja Completa', size: 'Carta / A4', icon: <div className="w-full h-20 bg-gray-50 rounded border border-gray-100 flex items-center justify-center p-4"><div className="w-10 h-14 border border-gray-300 bg-white relative"><div className="absolute inset-2 border border-gray-200"></div></div></div> },
                                ...
                                { id: LabelFormat.MinimalSticker, name: 'Brother Sticker', size: '62x100mm', icon: <div className="w-full h-20 bg-gray-50 rounded border-2 border-gray-200 flex items-center justify-center"><div className="w-14 h-8 border border-gray-300 bg-white"></div></div> },
                            ].map(fmt => (
                                <button
                                    key={fmt.id}
                                    type="button"
